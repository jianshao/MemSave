...
在连续 20 轮的正常开发对话测试中（使用qwen2.5:7b本地模型）：


| 指标 | 原生 Agent 模式 | MemSave 驱动模式 | 优化率 |
| :--- | :--- | :--- | :--- |
| **单次请求平均 Token** | 8050 | **3988** | **↘ 49.6%** |
| **长期事实召回率** | 未知 | **无丢失** | **↗ 100%** |
<img width="844" height="198" alt="企业微信截图_17757854826532" src="https://github.com/user-attachments/assets/f5bbd7b7-271c-45ce-aae7-2b27839bff67" />
